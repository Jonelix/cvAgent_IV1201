                            ...
                            {competencies.length > 0 ? (
                                <ul className="mt-4 text-gray-700">
                                    {competencies.map((competence, index) => (
                                        <li key={index} className="mb-2 p-2 bg-gray-100 rounded-lg shadow-sm">{competence.name}</li>
                                    ))}
                                </ul>
                            ) : (
                                <p className="text-gray-500 mt-2">(Competence details will be displayed here)</p>
                            )}
                        </div>
